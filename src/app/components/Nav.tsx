...
const Nav = ({ searchQuery, onSearchChange }: NavProps) => {
  ...
  const [isContactOpen, setIsContactOpen] = useState(false); // <-- 2. Add state for modal
  ...
  return (
    ...
    <>
      <header className="fixed top-0 left-0 right-0 z-50 bg-blue-950/80 backdrop-blur-md border-b border-gray-800">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            {/* --- 4. Replace Desktop Link with Button --- */}
            <button
          ...
          <div className="md:hidden bg-blue-950 border-t border-gray-800">
            <div className="container mx-auto px-6 py-4 space-y-4">
              ...
              <nav className="flex flex-col space-y-2">
                ...
                {/* --- 5. Replace Mobile Link with Button --- */}
                <button
                  onClick={() => {
      ...
      {/* --- 6. Render the modal (it's invisible until isOpen is true) --- */}
      <ContactModal
